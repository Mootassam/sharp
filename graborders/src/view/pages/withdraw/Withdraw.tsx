      ...
      <div className="withdraw__page">
        <div className="withdraw__content">
          <div className="withdraw__header">
            ...
            <span style={{ color: "white", fontSize: "14px" }}>
              Availabe balance : {currentUser?.balance?.toFixed(2) || 0} 
            </span>
          </div>
          <FormProvider {...form}>
        ...
        <div className="withdraw__rules">
          ...
          <ul className="rules__list">
            <li>
              (1) minimum withdraw is $20
            </li>
            <li>
              (2) The payment shall be made within 24 hours after withdrawal application is requested
            </li>
            <li>
